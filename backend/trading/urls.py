...
from .views import portfolio_list, portfolio_buy, UserRegistration, UserLogin, UserDetail, update_portfolio_and_balance, sorted_users, get_top_gainers, get_1y_stock_price, portfolio_sell
...
urlpatterns = [
    ...
    path('users/sorted/', sorted_users, name='sorted-users'),
    ...
    path('portfolios/sell/', portfolio_sell, name='portfolio-sell'),
]